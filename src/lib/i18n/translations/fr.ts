...
export const fr = {
  ...
  mail: {
    ...
    remove_reaction: "Supprimer la réaction",
    reaction_failed: "Échec de l'envoi de la réaction. Réessayer.",
    reaction_not_supported: "Les réactions sont disponibles uniquement entre utilisateurs Aster.",
