...
export const tr = {
  ...
  mail: {
    ...
    remove_reaction: "Tepkiyi kaldır",
    reaction_failed: "Tepki gönderilemedi. Tekrar deneyin.",
    reaction_not_supported: "Tepkiler yalnızca Aster kullanıcıları arasında kullanılabilir.",
    inbox: "Gelen Kutusu",
    sent: "Gönderilmiş",
    drafts: "Taslaklar",
    starred: "Yıldızlı",
